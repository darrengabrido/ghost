...
- 🌌 **Atmospheric UI** — a single watching "presence" (the cosmic
  eye) that dilates, churns, and blinks as Ghost listens, thinks, and
  speaks, over a deep-space canvas of starfield and nebula light.
